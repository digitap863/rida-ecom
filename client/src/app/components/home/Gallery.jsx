    ...
    return (
        <div>
            <div className='max-w-screen-2xl mx-auto px-4 py-8 lg:p-20'>
                <div className='grid lg:grid-cols-4 gap-4 font-urbanist'>
                    <div>
                    ...
                    <div className='space-y-3'>
                        <div className='relative overflow-hidden'>
                            <Image src={gallery_1} alt='gallery_1' className='hover:scale-105 duration-200 w-[80%] mx-auto lg:w-full' quality={100} />
                            <p className='absolute  bottom-3 lg:bottom-5 lg:text-xl uppercase left-10 lg:left-8 font-urbanist font-semibold  '>Truck</p>
                        </div>
                        <div className='relative overflow-hidden'>
                            <Image src={gallery_2} alt='gallery_2' className='hover:scale-105 duration-200 w-[80%] mx-auto lg:w-full' quality={100}/>
                            <p className='absolute bottom-3 lg:bottom-5 lg:text-xl uppercase left-10 lg:left-8 font-urbanist font-semibold  '>Truck</p>
                        </div>
                    </div>
                    <div className='space-y-3'>
                        <div className='relative overflow-hidden'>
                            <Image src={gallery_3} alt='gallery_3' className='hover:scale-105 duration-200 w-[80%] mx-auto lg:w-full' quality={100}/>
                            <p className='absolute bottom-3 lg:bottom-5 lg:text-xl uppercase left-10 lg:left-8 font-urbanist font-semibold  '>Bus</p>
                        </div>
                        <div className='relative overflow-hidden'>
                            <Image src={gallery_4} alt='gallery_4' className='hover:scale-105 duration-200 w-[80%] mx-auto lg:w-full' quality={100}/>
                            <p className='absolute bottom-3 lg:bottom-5 lg:text-xl uppercase left-10 lg:left-8 font-urbanist font-semibold  '>Bus</p>
                        </div>
                    ...
                    <div className='space-y-3'>
                        <div className='relative overflow-hidden'>
                            <Image src={gallery_5} alt='gallery_5' className='hover:scale-105 duration-200 w-[80%] mx-auto lg:w-full' quality={100}/>
                            <p className='absolute bottom-3 lg:bottom-5 lg:text-xl uppercase left-10 lg:left-8 font-urbanist font-semibold  '>Truck</p>
                        </div>
                        <div className='relative overflow-hidden'>
                            <Image src={gallery_6} alt='gallery_6' className='hover:scale-105 duration-200 w-[80%] mx-auto lg:w-full' quality={100}/>
                            <p className='absolute bottom-3 lg:bottom-5 lg:text-xl uppercase left-10 lg:left-8 font-urbanist font-semibold  '>Truck</p>
                        </div>
                    </div>
