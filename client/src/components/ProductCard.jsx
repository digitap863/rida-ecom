...
const ProductCard = ({ product }) => {
  ...
  return (
    <Card
      className="sm:aspect-[1/1.2] group hover:shadow-lg transition-shadow duration-300 relative overflow-hidden flex"
      onClick={handleClick}
    >
      {/* <div className="flex sm:flex-none "> */}
        {/* Image Container */}
        <div className="w-1/2 sm:w-auto p-3 h-[200px] relative flex justify-center items-center mx-auto ">
          {/* Loading Skeleton */}
          {isLoading && (
          ...
          <Image
            ...
            className={`
            mx-auto object-contain w-[120px] h-[120px] sm:w-full sm:h-full transition-all duration-300 
        ...
        {/* Content Container */}
        <div className="w-1/2  p-5 font-urbanist space-y-3 sm:absolute bottom-0 left-0 sm:w-full">

          {/* Product Name */}
          <h3 className="font-bold text-lg line-clamp-2 min-h-[30px] truncate">
            {product.name}
          </h3>
          {/* Part Number Badge */}
